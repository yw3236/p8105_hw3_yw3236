...
data(brfss_smart2010) #read the dataset
```
...
order_aisles = instacart %>%
  ...
  ggplot() +  
  geom_point(aes(x = reorder(aisle, -item_num), y = item_num)) +
...
There are two peaks in the hex plot.
...
Each year's violin plot is relatively same. 
